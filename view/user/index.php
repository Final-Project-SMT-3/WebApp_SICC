...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#"><button class="btn"><b>Beranda</b>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#informasi"><button class="btn"><b>Informasi</b>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="#faq"><button class="btn"><b>FAQ</b>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active " href="#"><button
                                class="btn btn-light text-center rounded-pill"><b>Pendaftaran</b></button></a>
                    </li>
    ...
    <section class="p-5" id="faq">
        ...
        <p class="fs-5 text-center"> Berikut merupakan beberapa pertanyaan yang selalu ditanyakan, semoga bisa menjawab
        </p>
        <div class="container">
            <div class="accordion">
                ...
                <div class="accordion-item">
                    ...
                    <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div class="accordion-body">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus debitis consequatur eius
                            at veritatis provident.
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-4 mx-auto mb-4">
                        ...
                        <p><i class="fas fa-home mr-3"></i> Jl. Mastrip No.164, Lingkungan Panji, Tegalgede, Kec.
                            Sumbersari, Kabupaten Jember, Jawa Timur 68121</p>
